...
const PinDetail = ({ user }) => {
  ...
  return (
    <>
      <div
        className="flex xl:flex-rows flex-col m-auto bg-white "
      ...
      >
        <div className="flex   justify-center items-center md:items-start flex-initial  ">
          <img
            ...
            alt="pin"
            className="rounded-t-3xl rounded-b-lg  h-100 max-h-screen"
          />
        </div>
        <div className="w-full p-5 flex-1 xl:min-w-620">
          <div className="flex items-center justify-between">
            ...
            <a href={pinDetail.destination} target="_blank" rel="noreferrer">
              {pinDetail.destination.slice(12, 35)}
            </a>
          </div>
          <div>
          ...
          <h2 className="mt-5 text-2xl">
            Commments (
            {pinDetail?.comments ? pinDetail?.comments?.length : null})
          </h2>
          ...
          <div className="flex flex-wrap mt-6 gap-3 ">
            ...
            >
              <img
                src={pinDetail.postedBy?.image}
                alt="user-logo"
                className="w-8 h-8 rounded-full object-cover top-0"
              ></img>
            </Link>
            <input
      ...
      {pins?.length > 0 ? (
        <>
          <h2 className="text-center font-bold mt-8 mb-4 text-2x">
            More like this
          </h2>
